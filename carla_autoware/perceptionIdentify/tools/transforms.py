...
def carla_rotation_to_ros_quaternion(carla_rotation):
    ...
    ros_quaternion.x = round(quat[1], 3)
    ros_quaternion.y = round(quat[2], 3)
    ros_quaternion.z = round(quat[3], 3)
    ros_quaternion.w = round(quat[0], 3)
...
#     relative_transform =  carla_transform_to_ros_pose(carla_actor.get_transform())
