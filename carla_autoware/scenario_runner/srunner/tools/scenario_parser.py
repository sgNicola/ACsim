        ...
        for file_name in list_of_config_files:
            ...
            for scenario in tree.iter("scenario"):
                ...
                for weather in scenario.iter("weather"):
                    ...
                    new_config.weather.precipitation = float(weather.attrib.get("precipitation", 90))
                    new_config.weather.precipitation_deposits = float(weather.attrib.get("precipitation_deposits", 90))
