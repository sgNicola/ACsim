...
def run_aid_experiments(X1, Y1, object_types):
                ...
                for object_type in object_types[l:]:
                    try:
                        ...
                        if len(Chain)>1:
                            ...
                            results = {'C': C,'X': X, 'id':id}
                        else:
                            results ={'C': Chain,'X': X, 'id':id}
...
if __name__ == "__main__":
    ...
    #     "object_type": None
    # }
    # run_aid_experiments(X1, Y1, object_types)
    # scenario="Truck_walker"
    # X1 =[5,6,6.5,7,7.5,8,8.5,9,9.5,10]
    # Y1 =[0,-1,-0.5]
    # object_types =['vehicle.bh.crossbike','vehicle.gazelle.omafiets',
